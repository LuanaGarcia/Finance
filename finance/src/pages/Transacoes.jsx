...
<<<<<<< HEAD
        ...
        {/* NAVEGADOR DE MESES */}
        <div className="flex items-center gap-4 bg-white p-2 rounded-2xl shadow-sm border border-[var(--brand-border)]">
          <button onClick={handlePrevMonth} className="p-2 hover:bg-[var(--brand-soft)] text-[var(--brand)] rounded-xl transition-colors">
            <ChevronLeft size={24} />
          </button>
          <span className="font-bold text-[var(--brand-dark)] min-w-[140px] text-center capitalize text-lg">
            {monthName}
          </span>
